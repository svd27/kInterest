...
class JetTest : FreeSpec({
    ...
    log.info { System.getProperty("bla") }
    log.info { "info.kinterest.datastores.hazelcast.jet.jarlocation: ${System.getProperty("info.kinterest.datastores.hazelcast.jet.jarlocation")}" }
