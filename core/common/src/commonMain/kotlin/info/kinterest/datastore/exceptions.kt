...
class DatastoreKeyNotFound(val meta: KIEntityMeta, id:Any, ds: Datastore, cause: Throwable?=null) : DatastoreError(ds, "Key $id not found for Entity ${meta.name}", cause)
class DatastoreUnknownType(val meta: KIEntityMeta, ds: Datastore, cause: Throwable?=null) : DatastoreError(ds, "Type ${meta.name} not known", cause)
